...
#ifndef INCLUDE_EXADG_DARCY_USER_INTERFACE_FIELD_FUNCTIONS_H_
#define INCLUDE_EXADG_DARCY_USER_INTERFACE_FIELD_FUNCTIONS_H_
...
struct FieldFunctions
{
  ...
  /*
   * The tensor function inverse_permeability_field is used to calculate the coefficient in the
   * mass operator for the Darcy problem.
   */
  std::shared_ptr<dealii::Function<dim>> inverse_permeability_field;

  /*
   * The function porosity_field is used to calculate the coefficient in the mass operator for
   * the Darcy problem.
   */
