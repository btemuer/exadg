...
#ifndef INCLUDE_EXADG_DARCY_USER_INTERFACE_IMPLEMENT_GET_APPLICATION_H_
#define INCLUDE_EXADG_DARCY_USER_INTERFACE_IMPLEMENT_GET_APPLICATION_H_
...
#endif /* INCLUDE_EXADG_DARCY_USER_INTERFACE_IMPLEMENT_GET_APPLICATION_H_ \
        */
